  ...
  return (
    <main className="flex flex-col font-luciole min-h-screen justify-between items-center bg-white text-black">
      ...
      <div className="flex flex-col m-4 space-y-4 items-center text-center">
        ...
        <Link href="https://www.youtube.com/@naapp_app" className="p-1 bg-gradient-to-r from-[#CB0000] from-60% to-[#AF81DF] text-red-500 font-bold hover:animate-zoomIn rounded-full w-full tablet:w-1/2 pc:w-1/3" id="discord">
        ...
        <Link href="https://open.spotify.com/user/31kn2za6r6axcgwtfsjmav5seoce?si=0550a34ac9254720" className="p-1 bg-gradient-to-r from-[#1DB954] from-60% to-[#8EA8F6] text-green-500 font-bold hover:animate-zoomIn rounded-full w-full tablet:w-1/2 pc:w-1/3" id="discord">
