...
export default function Community() {
    return (
        <main className="flex flex-col min-h-screen justify-between items-center bg-white text-black">
            <Header />
            <div className="flex flex-col pc:flex-row justify-between w-full p-5 mt-5">
                <div className="w-1/2 h-[10rem] bg-gray-700 self-center">
                    
                </div>
                <div className="flex flex-col space-y-3 pc:w-1/2 tablet:px-5 text-center">
                    <h2 className="text-4xl font-bold">
                        Nouvelle vidéo : La neuroatypie, les bases
                    </h2>
            ...
            <div className="flex flex-col pc:flex-row-reverse justify-between w-full p-5">
                <div className="pc:w-1/2 flex justify-center">
                    <img src="/img/community/Podcast.png" alt="podcast" className="w-9/10 pc:w-2/3" />
                </div>
